<x-layout title="Tworzenie spisu">
    <div class="max-w-xl mx-auto bg-slate-900 p-6 rounded-xl shadow-lg border border-teal-700/50">
        <h1 class="text-2xl font-bold text-teal-300 mb-4">Nowy spis</h1>
        ...
        <form action="{{ route('spisy.store') }}" method="POST">
            ...
            <button type="submit" class="bg-teal-700 hover:bg-teal-600 text-white font-semibold py-2 px-4 rounded">
                Utwórz spis
            </button>
        </form
    </div>
