        ...
        <div class="inline-block bg-gradient-to-br from-black via-slate-950 to-slate-900 rounded-lg shadow-lg p-8 border border-teal-700/50 text-center">
            ...
            <div class="flex justify-center flex-wrap gap-6 mb-4">
                <a href="{{ route('spisy.create', ['region_id' => 1]) }}"
                   class="bg-teal-800 hover:bg-teal-600 text-slate-100 font-semibold py-3 px-6 rounded-2xl shadow-md border border-teal-800/50 transition">
                   Magazyn
                </a>
            ...
            <div class="border-t border-teal-700/50 pt-6">
